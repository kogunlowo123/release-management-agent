"""Release Management Agent - FastAPI Application."""
...
app = FastAPI(
    ...
    description="Release orchestration agent that manages semantic versioning, generates changelogs, coordinates release trains, automates release notes, manages feature flags, and tracks release health metrics post-deployment.",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
    lifespan=lifespan,
